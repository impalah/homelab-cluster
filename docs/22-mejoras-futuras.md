...
| 32 | Dominio real + certificados Let's Encrypt (sustituye CA interna) | Media | Medio-alto | CA interna ya desplegada (`docs/15`); renovación ACME desacoplada de Traefik (un único escritor), ver mejora 39 |
