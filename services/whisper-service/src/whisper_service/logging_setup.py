...
`logging` (por ejemplo, de Uvicorn, FastAPI o faster-whisper/ctranslate2)
hacia Loguru, de forma que todo el logging de la aplicación pasa por un
único sistema y formato consistente.
"""
